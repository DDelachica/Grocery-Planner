# Generated by Django 2.2 on 2020-06-01 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_by', to='grocery_planner_app.User')),
                ('ingredients', models.ManyToManyField(related_name='ingredients_to', to='grocery_planner_app.Ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Meal',
