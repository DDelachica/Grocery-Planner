...
class Meal(models.Model):
    ...
    recipe = models.ForeignKey (Recipe, related_name='recipe_meals', on_delete=models.CASCADE)
    scheduler = models.ForeignKey(User, related_name='user_meals', on_delete=models.CASCADE)